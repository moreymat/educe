...
from educe.annotation import Span, RelSpan, Unit, Relation, Schema, Document
...
class LightGraph:
    ...
    def _mk_doc(self):
        ...
        for du_name, speaker_set in self.speakers.items():
            ...
            du = Unit(du_glozz_id, Span(du_start, du_start+1), 'Segment',
                      dict())
            speaker = list(speaker_set)[0]
            turn = Unit('t' + du_glozz_id, Span(du_start, du_start+1), 'Turn',
